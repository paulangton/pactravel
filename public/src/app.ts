...
let example2 =
  JSON.stringify({'links': [], 'multigraph': false, 'nodes': [{'title': 'Boston Logan Airport', 'wiki': '', 'img': '', 'desc': 'Airport', 'id': 0, 'location': [42.3656132, -71.00956020000001], 'isAirport': true},
